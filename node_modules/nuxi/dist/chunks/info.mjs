...
import { g as getPackageManager, a as getPackageManagerVersion } from '../shared/nuxi.78ac88cc.mjs';
import { f as findup } from '../shared/nuxi.9a68f9c8.mjs';
...
const info = defineNuxtCommand({
  ...
  async invoke(args) {
    ...
    const listModules = (arr = []) => arr.map((m) => normalizeConfigModule(m, rootDir)).filter(Boolean).map((name) => {
