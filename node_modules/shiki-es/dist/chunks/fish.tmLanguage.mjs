...
export { $schema, fish_tmLanguage as default, fileTypes, firstLineMatch, foldingStartMarker, foldingStopMarker, keyEquivalent, name, patterns, repository, scopeName, uuid };
